  ...
  return (
    <div className=" w-full">
      ...
      <section className=" container px-2 lg:w-2/3 mx-auto">
        <div className="">
          <h1 className="text-white lg:w-2/3 font-bold text-xl">Search for "One Piece"  </h1>

        </div>
      </section>
      <section className=" container py-10 space-y-2  px-2 lg:w-2/3 mx-auto">
        {array.map(i => {
          return <div className="flex w-full bg-gradient-to-r p-[2px] hover:from-[#FFE817]  hover:via-[#ff0080] rounded-lg to-[#7000FF]">
